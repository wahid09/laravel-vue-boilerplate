                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item menu-open">
                            <router-link to="/app/dashboard" active-class="active" class="nav-link">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview ml-2">
                                <li class="nav-item">
                                    <router-link to="/app/division" active-class="active" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Division</p>
                                    </router-link>
                                </li>
                                <li class="nav-item">
                                    <router-link to="/app/unit" active-class="active" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Unit</p>
                                    </router-link>
                                </li>
